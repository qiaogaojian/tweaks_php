...
0
|| checktplrefresh('data/diy/./template/dean_source_170511//forum/forumdisplay.htm', './template/default/forum/forumdisplay_leftside.htm', 1532330109, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/dean_source_170511/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/dean_source_170511//forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1532330109, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/dean_source_170511/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/dean_source_170511//forum/forumdisplay.htm', './template/default/common/seccheck.htm', 1532330109, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/dean_source_170511/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/dean_source_170511//forum/forumdisplay.htm', './template/dean_source_170511/forum/recommend.htm', 1532330109, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/dean_source_170511/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/dean_source_170511//forum/forumdisplay.htm', './template/dean_source_170511/forum/forumdisplay_list.htm', 1532330109, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/dean_source_170511/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/dean_source_170511//forum/forumdisplay.htm', './template/default/forum/forumdisplay_sort.htm', 1532330109, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/dean_source_170511/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/dean_source_170511//forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1532330109, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/dean_source_170511/', 'forum/forumdisplay')
;
block_get('59,60,61,63,64,62,65');?><?php include template('common/header'); if($_G['forum']['ismoderator']) { ?>
...
<?php } ?>
<!--版块介绍-->
        <div class="deanbkjsbg"><img src="<?php echo $_G['style']['styleimgdir'];?>/forumlist/bg1.jpg" /></div>
        <div class="deanbkjs">
            <div class="deanjstop">
                   ...
                   <div class="deanjscenter">
                        <?php if($_G['page'] == 1 && $_G['forum']['rules']) { ?>
                            ...
                            <div id="forum_rules_<?php echo $_G['fid'];?>" style="<?php echo $collapse['forum_rules'];?>;">
                                <div class="deanguize"><?php echo $_G['forum']['rules'];?></div>
                            </div>
                        <?php } ?>
                    </div>	
                </div>
        ...
        <div class="deanbbsjj">
            <div class="deanbbsjjl">
            	<div class="deanbbstop">
                	<!--[diy=deanbbstop]--><div id="deanbbstop" class="area"><div id="framej7TnTu" class="frame move-span cl frame-1"><div id="framej7TnTu_left" class="column frame-1-c"><div id="framej7TnTu_left_temp" class="move-span temp"></div><?php block_display('59');?></div></div></div><!--[/diy]-->
                	
                </div>
                <div class="deanbbsbottom">
                	<ul>
                    	<!--[diy=deanbbsbottom]--><div id="deanbbsbottom" class="area"><div id="frameAQFXdX" class="frame move-span cl frame-1"><div id="frameAQFXdX_left" class="column frame-1-c"><div id="frameAQFXdX_left_temp" class="move-span temp"></div><?php block_display('60');?></div></div></div><!--[/diy]-->
            ...
            <div class="deanbbsjjr">
            	<ul>
                	<!--[diy=deanbbsjjr]--><div id="deanbbsjjr" class="area"><div id="frameb6A6DK" class="frame move-span cl frame-1"><div id="frameb6A6DK_left" class="column frame-1-c"><div id="frameb6A6DK_left_temp" class="move-span temp"></div><?php block_display('61');?></div></div></div><!--[/diy]-->
...
<div class="bm_c cl"><div class="z dean_bbtj">本版推荐主题</div>
...
<ul class="z cl xe1 mbm dean_fdtl <?php if(!$_G['forum']['allowside']) { ?>k<?php } ?>">
<?php } else { ?>
<ul class="z cl xe2 mbm dean_fdtl <?php if(!$_G['forum']['allowside']) { ?>k<?php } ?>">
<?php } unset($_G['forum']['recommendlist']['images']);?><?php if(is_array($_G['forum']['recommendlist'])) foreach($_G['forum']['recommendlist'] as $rtid => $recommend) { ?><li class="dean_bgimg"><a href="forum.php?mod=viewthread&amp;tid=<?php echo $rtid;?>" <?php echo $recommend['subjectstyles'];?> target="_blank"><?php echo $recommend['subject'];?></a></li>
<?php } ?>
</ul>
...
<?php if(!empty($_G['setting']['pluginhooks']['forumdisplay_filter_extra'])) echo $_G['setting']['pluginhooks']['forumdisplay_filter_extra'];?>
                        <div class="y deanspace">
                            ...
                            <?php } else { ?>
                            <a<?php if(empty($_G['cookie']['forumdefstyle'])) { ?> href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;forumdefstyle=yes" class="deanwfpower chked"<?php } else { ?> href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;forumdefstyle=no" class="deanwfpower unchk"<?php } ?> title="图片模式浏览帖子">图片模式</a>
                            <?php } ?>
                        </div>
</div>
...
<td class="icn">
                                        <div class="forumava <?php if($thread['folder'] == 'lock' || $thread['special'] || $thread['displayorder']) { ?>s_lnoavatar<?php } ?>"> 
                                            ...
                                            <?php echo avatar($thread[authorid],large);?> 
                                            </a>
                                      	</div>
                                        <a class="deanthreads_author" href="home.php?mod=space&amp;uid=<?php echo $thread['authorid'];?>" c="1"><?php echo $thread['author'];?></a>
                                    </td>
...
<img src="<?php echo $_G['style']['styleimgdir'];?>/forumlist/pin_<?php echo $thread['displayorder'];?>.png" alt="<?php echo $_G['setting']['threadsticky'][3-$thread['displayorder']];?>" />
<?php } else { ?>
...
<?php } } ?>
                                        ...
                                        <?php include 'template/dean_source_170511/php/summary.php'?>                                                <?php echo cutstr($summary_echo,200); ?>                                        </div>

                                        <div class="deanforumlist_pics">
                                        <?php include 'template/dean_source_170511/php/innerpics.php'?><?php if(is_array($yuerbaike)) foreach($yuerbaike as $hypic) { ?>                                        	<a href="forum.php?mod=viewthread&amp;tid=<?php echo $thread['tid'];?>" target="_blank">
                                            	<img src="data/attachment/forum/<?php echo $hypic['attachment'];?>">
                                            </a>
                                            <?php } ?>
                                            <div class="clear"></div>
                                        </div>
                                        ...
                                        最后发表:
                                        <span><?php if($thread['lastposter']) { ?><a href="<?php if($thread['digest'] != -2) { ?>home.php?mod=space&username=<?php echo $thread['lastposterenc'];?><?php } else { ?>forum.php?mod=viewthread&tid=<?php echo $thread['tid'];?>&page=<?php echo max(1, $thread['pages']);; } ?>" c="1"><?php echo $thread['lastposter'];?></a><?php } else { ?><?php echo $_G['setting']['anonymoustext'];?><?php } ?></span><em class="deanatsign">@</em>
<?php echo $thread['lastpost'];?>
                                        ...
                                        <i class="y">
                                            ...
                                            <span class="dean_ftdate"><?php echo $thread['dateline'];?></span>
                                        </i>
...
<?php } ?>
                                    ...
                                    <div class="deanscbmtx">
                                    	<?php if($thread['authorid'] && $thread['author']) { ?>
                                            <a href="home.php?mod=space&amp;uid=<?php echo $thread['authorid'];?>">
                                                ...
                                                <?php if($thread['authorid'] && $thread['author']) { ?>
                                                <em><?php echo $thread['author'];?></em><?php if(!empty($verify[$thread['authorid']])) { ?> <?php echo $verify[$thread['authorid']];?><?php } ?>
                                                <?php } ?>
                                            </a>
                                            <?php if(!empty($verify[$thread['authorid']])) { ?> <?php echo $verify[$thread['authorid']];?><?php } ?>
                                        <?php } else { ?>
                                ...
                                <div class="deanscbbs">
                                    <i class="deanscviews"><?php echo $thread['views'];?></i>
                                    <i class="deansccomments"><?php echo $thread['replies'];?></i>
                                    <i class="deansczans"><?php echo $thread['recommends'];?></i>
...
<script src="<?php echo $_G['style']['styleimgdir'];?>/js/redef.js" type="text/javascript"></script>
...
<div class="sd">
            ...
            <div class="deansidebox">
                ...
                <div class="deantuijianbox">
                    <!--[diy=deantuijianbox]--><div id="deantuijianbox" class="area"><div id="frameZ2W5l2" class="frame move-span cl frame-1"><div id="frameZ2W5l2_left" class="column frame-1-c"><div id="frameZ2W5l2_left_temp" class="move-span temp"></div><?php block_display('63');?></div></div></div><!--[/diy]-->
                    
                </div>
                <div class="deansdlists">
                    <ul>
                        <!--[diy=deansdlists]--><div id="deansdlists" class="area"><div id="framenUMrHH" class="frame move-span cl frame-1"><div id="framenUMrHH_left" class="column frame-1-c"><div id="framenUMrHH_left_temp" class="move-span temp"></div><?php block_display('64');?></div></div></div><!--[/diy]-->
            ...
            <div class="deansidebox" style="margin-bottom:10px;">
                ...
                <div class="deanranklistbox">
                    <ul>
                        <!--[diy=deanranklistbox]--><div id="deanranklistbox" class="area"><div id="framekzApL8" class="frame move-span cl frame-1"><div id="framekzApL8_left" class="column frame-1-c"><div id="framekzApL8_left_temp" class="move-span temp"></div><?php block_display('62');?></div></div></div><!--[/diy]-->
                    </ul>
                </div>
                <script type="text/javascript">
...
jq(this).addClass("on").siblings().removeClass("on");
            ...
            <div class="deansidebox">
                ...
                <div class="deanadsside">
                    <!--[diy=deanadsside]--><div id="deanadsside" class="area"><div id="frameazWc1I" class="frame move-span cl frame-1"><div id="frameazWc1I_left" class="column frame-1-c"><div id="frameazWc1I_left_temp" class="move-span temp"></div><?php block_display('65');?></div></div></div><!--[/diy]-->
