...
0
|| checktplrefresh('./template/dean_source_170511/portal/view_new.htm', './template/dean_source_170511/portal/portal_comment.htm', 1501344391, 'diy', './data/template/2_diy_portal_view_new.tpl.php', './template/dean_source_170511', 'portal/view_new')
|| checktplrefresh('./template/dean_source_170511/portal/view_new.htm', './template/default/common/seccheck.htm', 1501344391, 'diy', './data/template/2_diy_portal_view_new.tpl.php', './template/dean_source_170511', 'portal/view_new')
;?><?php include template('common/header'); ?><!--[name][www.wfdsoft.com素材资源教程下载2-频道内容页][/name]-->
  ...
  jQuery(this).removeClass("bgchange");
    ...
    <p class="ptn cl" style=" text-align:center">
    	...
    	<div class="sd pph">
            ...
            <div class="deansidebox">
                <div class="deangltt">
                    <!--[diy=deangltt2]--><div id="deangltt2" class="area"></div><!--[/diy]-->
                    <div class="clear"></div>
                </div>
                <div class="deangllists">
                    <ul>
                        <!--[diy=deangllists]--><div id="deangllists" class="area"></div><!--[/diy]-->
                    </ul>
                </div>
            </div>
            ...
            <div class="deansidebox">
                ...
                <div class="deanonvideos">
                    <ul>
                        <!--[diy=deangamestt1ss]--><div id="deangamestt1ss" class="area"></div><!--[/diy]-->
                        <div class="clear"></div>
                    </ul>
                </div>
...
jq(this).addClass("on").siblings().removeClass("on");
            ...
            <div class="deansidebox">
                ...
                <div class="deanimg_news">
                    <!--[diy=deanimg_news]--><div id="deanimg_news" class="area"></div><!--[/diy]-->
