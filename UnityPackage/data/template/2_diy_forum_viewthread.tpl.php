...
0
|| checktplrefresh('data/diy/./template/dean_source_170511//forum/viewthread.htm', './template/dean_source_170511/forum/viewthread_node.htm', 1532332372, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', 'data/diy/./template/dean_source_170511/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/dean_source_170511//forum/viewthread.htm', './template/dean_source_170511/forum/viewthread_fastpost.htm', 1532332372, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', 'data/diy/./template/dean_source_170511/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/dean_source_170511//forum/viewthread.htm', './template/dean_source_170511/forum/viewthread_node_body.htm', 1532332372, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', 'data/diy/./template/dean_source_170511/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/dean_source_170511//forum/viewthread.htm', './template/default/common/seditor.htm', 1532332372, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', 'data/diy/./template/dean_source_170511/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/dean_source_170511//forum/viewthread.htm', './template/default/forum/seccheck_post.htm', 1532332372, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', 'data/diy/./template/dean_source_170511/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/dean_source_170511//forum/viewthread.htm', './template/default/common/upload.htm', 1532332372, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', 'data/diy/./template/dean_source_170511/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/dean_source_170511//forum/viewthread.htm', './template/default/common/seccheck.htm', 1532332372, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', 'data/diy/./template/dean_source_170511/', 'forum/viewthread')
;
block_get('66,67,68,70,71,69,72');?><?php include template('common/header'); $ucthread = C::t('forum_thread')->fetch_all_by_authorid($_G['forum_thread']['authorid'], 0,8);?><?php $ucauthor = DB::fetch_first("SELECT `follower`,`threads`,`following` FROM ".DB::table('common_member_count')." WHERE uid = ".$_G['forum_thread']['authorid']);?><script type="text/javascript">var fid = parseInt('<?php echo $_G['fid'];?>'), tid = parseInt('<?php echo $_G['tid'];?>');</script>
...
<?php if(!empty($_G['setting']['pluginhooks']['viewthread_top'])) echo $_G['setting']['pluginhooks']['viewthread_top'];?><?php echo adshow("text/wp a_t");?><!--Green_modifacation-->
...
<div id="ct" class="wp cl <?php if($close_leftinfo) { ?> ct2<?php } ?>">
    ...
    <div class="mn" <?php if(!$close_leftinfo) { ?> style="width:100%">
        ...
        <div class="deanfbhf">
                <a class="deanfabuanniu" onclick="showWindow('newthread', 'forum.php?mod=post&amp;action=newthread&amp;fid=<?php echo $_G['fid'];?>')" href="javascript:;" title="发新帖">发布主题</a>
            <?php if($allowpostreply && !$_G['forum_thread']['archiveid']) { ?>
                <a class="deanpostreply" onclick="showWindow('reply', 'forum.php?mod=post&action=reply&fid=<?php echo $_G['fid'];?>&tid=<?php echo $_G['tid'];?>')" href="javascript:;" title="回复">回复</a>
            <?php } ?>
                <div class="clear"></div>
            </div>
        <?php } ?>
        ...
        <div class="deanbbsjj">
            <div class="deanbbsjjl">
            	...
            	<div class="deanbbstop">
                	<!--[diy=deanbbstop]--><div id="deanbbstop" class="area"><div id="framewPN77L" class="frame move-span cl frame-1"><div id="framewPN77L_left" class="column frame-1-c"><div id="framewPN77L_left_temp" class="move-span temp"></div><?php block_display('66');?></div></div></div><!--[/diy]-->
                	
                </div>
                <div class="deanbbsbottom">
                	<ul>
                    	<!--[diy=deanbbsbottom]--><div id="deanbbsbottom" class="area"><div id="frameOx3Xtt" class="frame move-span cl frame-1"><div id="frameOx3Xtt_left" class="column frame-1-c"><div id="frameOx3Xtt_left_temp" class="move-span temp"></div><?php block_display('67');?></div></div></div><!--[/diy]-->
            ...
            <div class="deanbbsjjr">
            	<ul>
                	<!--[diy=deanbbsjjr]--><div id="deanbbsjjr" class="area"><div id="framebpBgsG" class="frame move-span cl frame-1"><div id="framebpBgsG_left" class="column frame-1-c"><div id="framebpBgsG_left_temp" class="move-span temp"></div><?php block_display('68');?></div></div></div><!--[/diy]-->
    ...
    <div id="postlist" class="pl bm <?php if(!$close_leftinfo) { ?>deanconone<?php } else { ?>deanothers<?php } ?>">
        ...
        <div class="vwthdtit cl">
            ...
            <?php if($_G['setting']['close_leftinfo_userctrl']) { ?>
                ...
                <?php if(!$close_leftinfo) { ?>
                    <a onclick="setcookie('close_leftinfo', 1);location.reload();" title="收起左侧" class="btn_s_close" href="javascript:;"><img src="<?php echo $_G['style']['styleimgdir'];?>/viewthread/control_l.png" alt="收起左侧" class="vm" /></a>
                <?php } else { ?>
                    <a onclick="setcookie('close_leftinfo', 2);location.reload();" title="开启左侧" class="btn_s_open" href="javascript:;"><img src="<?php echo $_G['style']['styleimgdir'];?>/viewthread/control_r.png" alt="开启左侧" class="vm" /></a>
                <?php } ?>
...
<a href="javascript:;" id="ak_rate" onclick="showWindow('rate', 'forum.php?mod=misc&action=rate&tid=<?php echo $_G['tid'];?>&pid=<?php echo $post['pid'];?>', 'get', -1);return false;" title="评分表立场">
                        ...
                        <div class="deanicon_bottom"><span class="deansc">评分</span></div>
                        </a>
...
<a class="followp" href="home.php?mod=spacecp&amp;ac=follow&amp;op=relay&amp;tid=<?php echo $_G['tid'];?>&amp;from=forum" onclick="showWindow('relaythread', this.href, 'get', 0);" title="转播求扩散"><img src="<?php echo $_G['style']['styleimgdir'];?>/viewthread/zhuanbo.png" alt="转播" />
                        <div class="deanicon_bottom"><span class="deansc">转播</span><?php if($_G['forum_thread']['relay']) { ?><span id="relaynumber" ><?php echo $_G['forum_thread']['relay'];?></span><?php } ?></div>
...
<a href="forum.php?mod=collection&amp;action=edit&amp;op=addthread&amp;tid=<?php echo $_G['tid'];?>" id="k_collect" onclick="showWindow(this.id, this.href);return false;" onmouseover="this.title = $('collectionnumber').innerHTML + ' 人淘帖'" title="淘好帖进专辑"><img src="<?php echo $_G['style']['styleimgdir'];?>/viewthread/taotie.png" alt="分享" />
                        ...
                        <div class="deanicon_bottom"><span class="deansc">淘帖</span><span id="collectionnumber"<?php if(!$post['releatcollectionnum']) { ?> <?php } ?>><?php echo $post['releatcollectionnum'];?></span></div>
...
<h3 class="pbm mbm bbda deanrelatedthreads"><span>相关帖子</span></h3>
<ul class="xl xl2 cl deanthreadslists"><?php if(is_array($post['relateitem'])) foreach($post['relateitem'] as $var) { ?><li>
...
<?php } ?>
<a href="home.php?mod=spacecp&amp;ac=usergroup&amp;gid=<?php echo $post['groupid'];?>" target="_blank" class="deangrtxt"><?php echo $post['authortitle'];?></a>
<?php } } ?>
</div>
...
<?php if(!($_G['setting']['threadguestlite'] && !$_G['uid'])) { ?> 
                <?php if($thread['authorid'] != $_G['uid']) { ?>
                      <ul class="user_contact cl">
                          <?php if(helper_access::check_module('follow')) { ?>
                              <li class="user_flw">
                                  <a href="home.php?mod=spacecp&amp;ac=pm&amp;op=showmsg&amp;handlekey=showmsg_<?php echo $_G['forum_thread']['authorid'];?>&amp;touid=<?php echo $_G['forum_thread']['authorid'];?>&amp;pmid=0&amp;daterange=2&amp;tid=<?php echo $_G['tid'];?>" onclick="showWindow('sendpm', this.href);" title="发消息">发送私信</a>
                               </li>
...
<a class="deanfabu" onclick="showWindow('newthread', 'forum.php?mod=post&amp;action=newthread&amp;fid=<?php echo $_G['fid'];?>')" href="javascript:;" title="发新帖">发布主题</a>
        <!--推荐阅读-->
            <div class="deansidebox">
                ...
                <div class="deantuijianbox">
                    <!--[diy=deantuijianbox]--><div id="deantuijianbox" class="area"><div id="framefQ9cqq" class="frame move-span cl frame-1"><div id="framefQ9cqq_left" class="column frame-1-c"><div id="framefQ9cqq_left_temp" class="move-span temp"></div><?php block_display('70');?></div></div></div><!--[/diy]-->
                    
                </div>
                <div class="deansdlists">
                    <ul>
                        <!--[diy=deansdlists]--><div id="deansdlists" class="area"><div id="frameOdBF33" class="frame move-span cl frame-1"><div id="frameOdBF33_left" class="column frame-1-c"><div id="frameOdBF33_left_temp" class="move-span temp"></div><?php block_display('71');?></div></div></div><!--[/diy]-->
            ...
            <div class="deansidebox" style="margin-bottom:10px;">
                ...
                <div class="deanranklistbox">
                    <ul>
                        <!--[diy=deanranklistbox]--><div id="deanranklistbox" class="area"><div id="frameD3klQi" class="frame move-span cl frame-1"><div id="frameD3klQi_left" class="column frame-1-c"><div id="frameD3klQi_left_temp" class="move-span temp"></div><?php block_display('69');?></div></div></div><!--[/diy]-->
                    </ul>
                </div>
                <script type="text/javascript">
...
jq(this).addClass("on").siblings().removeClass("on");
            ...
            <div class="deansidebox">
                ...
                <div class="deanadsside">
                    <!--[diy=deanadsside]--><div id="deanadsside" class="area"><div id="frameDNnnVG" class="frame move-span cl frame-1"><div id="frameDNnnVG_left" class="column frame-1-c"><div id="frameDNnnVG_left_temp" class="move-span temp"></div><?php block_display('72');?></div></div></div><!--[/diy]-->
