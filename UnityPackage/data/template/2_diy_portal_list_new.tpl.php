<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_new');?><?php include template('common/header'); ?><!--[name][www.wfdsoft.com素材资源教程下载2-频道列表页][/name]--><?php $list = array();?><?php $wheresql = category_get_wheresql($cat);?><?php $list = category_get_list($cat, $wheresql, $page);?><div id="pt" class="bm cl">
<div class="z">
...
<div class="mn">
    	<div class="deanwzadsd">
        	<!--[diy=deanwzadsd]--><div id="deanwzadsd" class="area"></div><!--[/diy]-->
...
<div class="deansidebox">
        ...
        <!--ads-->
        <div class="deansideads"><!--[diy=deansideads]--><div id="deansideads" class="area"></div><!--[/diy]--></div>
