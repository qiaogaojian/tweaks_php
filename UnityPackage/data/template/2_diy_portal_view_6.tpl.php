...
0
|| checktplrefresh('data/diy/./template/dean_source_170511//portal/view_6.htm', './template/dean_source_170511/portal/portal_comment.htm', 1501344503, 'diy', './data/template/2_diy_portal_view_6.tpl.php', 'data/diy/./template/dean_source_170511/', 'portal/view_6')
|| checktplrefresh('data/diy/./template/dean_source_170511//portal/view_6.htm', './template/default/common/seccheck.htm', 1501344503, 'diy', './data/template/2_diy_portal_view_6.tpl.php', 'data/diy/./template/dean_source_170511/', 'portal/view_6')
;
block_get('176,177,178,179,181,180');?><?php include template('common/header'); ?><script src="<?php echo $_G['setting']['jspath'];?>forum_viewthread.js?<?php echo VERHASH;?>" type="text/javascript"></script>
    ...
    <p class="ptn cl" style=" text-align:center">
    	...
    	<div class="sd pph">
            ...
            <div class="deansidebox">
                ...
                <div class="focusBox">
                    <!--[diy=focusBox]--><div id="focusBox" class="area"><div id="frameKj3Wji" class="frame move-span cl frame-1"><div id="frameKj3Wji_left" class="column frame-1-c"><div id="frameKj3Wji_left_temp" class="move-span temp"></div><?php block_display('176');?></div></div></div><!--[/diy]-->
            ...
            <div class="deansidebox">
                <div class="deangltt">
                    <!--[diy=deangltt2]--><div id="deangltt2" class="area"><div id="frameu4i2id" class="frame move-span cl frame-1"><div id="frameu4i2id_left" class="column frame-1-c"><div id="frameu4i2id_left_temp" class="move-span temp"></div><?php block_display('177');?></div></div></div><!--[/diy]-->
                    <div class="clear"></div>
                </div>
                <div class="deangllists">
                    <ul>
                        <!--[diy=deangllists]--><div id="deangllists" class="area"><div id="frameOD5M5C" class="frame move-span cl frame-1"><div id="frameOD5M5C_left" class="column frame-1-c"><div id="frameOD5M5C_left_temp" class="move-span temp"></div><?php block_display('178');?></div></div></div><!--[/diy]-->
                    </ul>
                </div>
            </div>
            ...
            <div class="deansidebox">
                ...
                <div class="deanonvideos">
                    <ul>
                        <!--[diy=deangamestt1ss]--><div id="deangamestt1ss" class="area"><div id="frameuy43fM" class="frame move-span cl frame-1"><div id="frameuy43fM_left" class="column frame-1-c"><div id="frameuy43fM_left_temp" class="move-span temp"></div><?php block_display('179');?></div></div></div><!--[/diy]-->
                        <div class="clear"></div>
                    </ul>
                </div>
...
<div class="deansidebox">
            ...
            <div class="deanranklistbox">
                <ul>
                    <!--[diy=deanranklistbox]--><div id="deanranklistbox" class="area"><div id="frameiH7lhP" class="frame move-span cl frame-1"><div id="frameiH7lhP_left" class="column frame-1-c"><div id="frameiH7lhP_left_temp" class="move-span temp"></div><?php block_display('181');?></div></div></div><!--[/diy]-->
                </ul>
            </div>
            <script type="text/javascript">
...
jq(this).addClass("on").siblings().removeClass("on");
            ...
            <div class="deansidebox">
                ...
                <div class="deanimg_news">
                    <!--[diy=deanimg_news]--><div id="deanimg_news" class="area"><div id="frameX6e03S" class="frame move-span cl frame-1"><div id="frameX6e03S_left" class="column frame-1-c"><div id="frameX6e03S_left_temp" class="move-span temp"></div><?php block_display('180');?></div></div></div><!--[/diy]-->
