...
0
|| checktplrefresh('data/diy/./template/dean_source_170511//portal/view_7.htm', './template/dean_source_170511/portal/portal_comment.htm', 1501344551, 'diy', './data/template/2_diy_portal_view_7.tpl.php', 'data/diy/./template/dean_source_170511/', 'portal/view_7')
|| checktplrefresh('data/diy/./template/dean_source_170511//portal/view_7.htm', './template/default/common/seccheck.htm', 1501344551, 'diy', './data/template/2_diy_portal_view_7.tpl.php', 'data/diy/./template/dean_source_170511/', 'portal/view_7')
;
block_get('191,192,193,194,196,195');?><?php include template('common/header'); ?><script src="<?php echo $_G['setting']['jspath'];?>forum_viewthread.js?<?php echo VERHASH;?>" type="text/javascript"></script>
    ...
    <p class="ptn cl" style=" text-align:center">
    	...
    	<div class="sd pph">
            ...
            <div class="deansidebox">
                ...
                <div class="focusBox">
                    <!--[diy=focusBox]--><div id="focusBox" class="area"><div id="frameM61vz4" class="frame move-span cl frame-1"><div id="frameM61vz4_left" class="column frame-1-c"><div id="frameM61vz4_left_temp" class="move-span temp"></div><?php block_display('191');?></div></div></div><!--[/diy]-->
            ...
            <div class="deansidebox">
                <div class="deangltt">
                    <!--[diy=deangltt2]--><div id="deangltt2" class="area"><div id="framev116GL" class="frame move-span cl frame-1"><div id="framev116GL_left" class="column frame-1-c"><div id="framev116GL_left_temp" class="move-span temp"></div><?php block_display('192');?></div></div></div><!--[/diy]-->
                    <div class="clear"></div>
                </div>
                <div class="deangllists">
                    <ul>
                        <!--[diy=deangllists]--><div id="deangllists" class="area"><div id="frameJOi1qI" class="frame move-span cl frame-1"><div id="frameJOi1qI_left" class="column frame-1-c"><div id="frameJOi1qI_left_temp" class="move-span temp"></div><?php block_display('193');?></div></div></div><!--[/diy]-->
                    </ul>
                </div>
            </div>
            ...
            <div class="deansidebox">
                ...
                <div class="deanonvideos">
                    <ul>
                        <!--[diy=deangamestt1ss]--><div id="deangamestt1ss" class="area"><div id="frameoh4mmh" class="frame move-span cl frame-1"><div id="frameoh4mmh_left" class="column frame-1-c"><div id="frameoh4mmh_left_temp" class="move-span temp"></div><?php block_display('194');?></div></div></div><!--[/diy]-->
                        <div class="clear"></div>
                    </ul>
                </div>
...
<div class="deansidebox">
            ...
            <div class="deanranklistbox">
                <ul>
                    <!--[diy=deanranklistbox]--><div id="deanranklistbox" class="area"><div id="framefbejrj" class="frame move-span cl frame-1"><div id="framefbejrj_left" class="column frame-1-c"><div id="framefbejrj_left_temp" class="move-span temp"></div><?php block_display('196');?></div></div></div><!--[/diy]-->
                </ul>
            </div>
            <script type="text/javascript">
...
jq(this).addClass("on").siblings().removeClass("on");
            ...
            <div class="deansidebox">
                ...
                <div class="deanimg_news">
                    <!--[diy=deanimg_news]--><div id="deanimg_news" class="area"><div id="frameMS41c4" class="frame move-span cl frame-1"><div id="frameMS41c4_left" class="column frame-1-c"><div id="frameMS41c4_left_temp" class="move-span temp"></div><?php block_display('195');?></div></div></div><!--[/diy]-->
