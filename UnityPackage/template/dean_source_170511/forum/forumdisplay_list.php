			...
			<tr>
				...
				<!--{if CURMODULE != 'guide'}-->
					<div class="deanbiaotou">
                        ...
                        <div class="deanpaixu">
                        <a id="filter_orderby" href="javascript:;" class="showmenu " onclick="showMenu(this.id)" initialized="true">≈≈–Ú∑Ω Ω</a>
                        </div>		
								...
								<tr class="deanactions fadeIn">
									...
									<th class="$thread[folder] forumtit">
                                        ...
                                        <div class="deanthreads_summary">
                                        	<!--{eval include 'template/dean_source_170511/php/summary.php'}-->
                                                <!--{echo cutstr($summary_echo,200)}-->
                                        </div>

                                        <div class="deanforumlist_pics">
                                        	<!--{eval include 'template/dean_source_170511/php/innerpics.php'}-->
