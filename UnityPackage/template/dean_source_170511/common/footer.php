...
<!--{if empty($topic) || ($topic[usefooter])}-->
    ...
    <div class="deanfooter">
        ...
        <div class="deanftbottom">
                ...
                <p>
                    Powered by <a href="http://www.wfdsoft.com" target="_blank">wfdsoft!</a> <em>$_G['setting']['version']</em><!--{if !empty($_G['setting']['boardlicensed'])}--> <a href="http://license.comsenz.com/?pid=1&host=$_SERVER[HTTP_HOST]" target="_blank">Licensed</a><!--{/if}-->&copy; 2001-2013 <a href="http://www.wfdsoft.com" target="_blank">wfdsoft Inc.</a>&nbsp;&nbsp;<!--{if $_G['setting']['icp']}--><a href="http://www.miitbeian.gov.cn/" target="_blank">$_G['setting']['icp']</a><!--{/if}-->
                </p>
                <div class="deanbutNav">
                  <a title="工商网监" href="http://www.wfdsoft.com" target="_blank"><img src="$_G['style'][styleimgdir]/footer/botpic_r1_c4.png"></a>
                  <a title="安全联盟实名认证" href="http://www.wfdsoft.com" target="_blank"><img src="$_G['style'][styleimgdir]/footer/botpic_r1_c1.jpg"></a>
                  <a href="http://www.wfdsoft.com" target="_blank">
                  <img src="$_G['style'][styleimgdir]/footer/botpic_r1_c5.png" width="100" alt="安全联盟认证"/>
                  </a>
                  <a title="财付通" href="http://www.wfdsoft.com" target="_blank"><img src="$_G['style'][styleimgdir]/footer/botpic_r1_c2.jpg"></a>
                  <a title="支付宝" href="http://www.wfdsoft.com" target="_blank"><img src="$_G['style'][styleimgdir]/footer/botpic_r1_c3.jpg"></a>
                </div>
            </div>
    </div>
