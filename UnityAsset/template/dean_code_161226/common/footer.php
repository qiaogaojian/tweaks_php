    	...
    	<div class="deanfttop">
        	<div class="w1180">
            	<div class="deanft_left">
                    ...
                    <div class="deancongz">
                        关注我们 :
                        <a class="weixin" href="javascript:void(0);"><img src="$_G['style'][styleimgdir]/footer/weixin.png"><img class="hide" src="$_G['style'][styleimgdir]/footer/hide.png"/></a>
                        <a class="weibo" href="#"><img src="$_G['style'][styleimgdir]/footer/weibo.png"></a>
                    </div>
                </div>
