...
block_get('49,50,51,52,56,54,55,53');?><?php include template('common/header'); ?>        <!--[diy=diy_chart]--><div id="diy_chart" class="area"></div><!--[/diy]-->
        <!--首页N格-->
        <div class="deannge deanactions fadeIn">
            <div class="deanltflash">
                <!--[diy=deanltflash]--><div id="deanltflash" class="area"><div id="framevJcmcS" class="frame move-span cl frame-1"><div id="framevJcmcS_left" class="column frame-1-c"><div id="framevJcmcS_left_temp" class="move-span temp"></div><?php block_display('49');?></div></div></div><!--[/diy]-->
                    ...
                    <dl>
                        <dd style="display:block;">
                            <div class="deannr_box">
                                <ul>
                                    <!--[diy=deannr_box]--><div id="deannr_box" class="area"><div id="frameet99T3" class="frame move-span cl frame-1"><div id="frameet99T3_left" class="column frame-1-c"><div id="frameet99T3_left_temp" class="move-span temp"></div><?php block_display('50');?></div></div></div><!--[/diy]-->
                        ...
                        <dd>
                            <div class="deannr_box">
                                <ul>
                                    <!--[diy=deannr_box1]--><div id="deannr_box1" class="area"><div id="frameEgzuJ7" class="frame move-span cl frame-1"><div id="frameEgzuJ7_left" class="column frame-1-c"><div id="frameEgzuJ7_left_temp" class="move-span temp"></div><?php block_display('51');?></div></div></div><!--[/diy]-->
                                </ul>
                            </div>
                        </dd>
                        <dd>
                            <div class="deannr_box">
                                <ul>
                                    <!--[diy=deannr_box2]--><div id="deannr_box2" class="area"><div id="frameG4sv2M" class="frame move-span cl frame-1"><div id="frameG4sv2M_left" class="column frame-1-c"><div id="frameG4sv2M_left_temp" class="move-span temp"></div><?php block_display('52');?></div></div></div><!--[/diy]-->
                                </ul>
                            </div>
                        </dd>
                    </dl>
        ...
        <div class="deangzhuyas">
        	<ul>
            	<!--[diy=deangzhuyas]--><div id="deangzhuyas" class="area"><div id="framea8V1Yb" class="frame move-span cl frame-1"><div id="framea8V1Yb_left" class="column frame-1-c"><div id="framea8V1Yb_left_temp" class="move-span temp"></div><?php block_display('56');?></div></div></div><!--[/diy]-->
                                ...
                                <table cellspacing="0" cellpadding="0" class="fl_tb">
                                    ...
                                    <?php $forum=$favforumlist[$favorite[id]];?>                                    <?php $forumurl = !empty($forum['domain']) && !empty($_G['setting']['domain']['root']['forum']) ? 'http://'.$forum['domain'].'.'.$_G['setting']['domain']['root']['forum'] : 'forum.php?mod=forumdisplay&fid='.$forum['fid'];?>                                        <?php if($forumcolumns>1) { ?>
                                            ...
                                            <td class="fl_g"<?php if($forumcolwidth) { ?> width="<?php echo $forumcolwidth;?>"<?php } ?>>
                                                <div class="fl_icn_g deanactions swing"<?php if(!empty($forum['extra']['iconwidth']) && !empty($forum['icon'])) { ?> style="width: <?php echo $forum['extra']['iconwidth'];?>px;"<?php } ?>>
                                                <?php if($forum['icon']) { ?>
                                                    <?php echo $forum['icon'];?>
                                                <?php } else { ?>
                                ...
                                <table cellspacing="0" cellpadding="0" class="fl_tb">
                                    ...
                                    <?php if(is_array($cat['forums'])) foreach($cat['forums'] as $forumid) { ?>                                    <?php $forum=$forumlist[$forumid];?>                                    <?php $forumurl = !empty($forum['domain']) && !empty($_G['setting']['domain']['root']['forum']) ? 'http://'.$forum['domain'].'.'.$_G['setting']['domain']['root']['forum'] : 'forum.php?mod=forumdisplay&fid='.$forum['fid'];?>                                    <?php if($cat['forumcolumns']) { ?>
                                        ...
                                        <td class="fl_g" width="<?php echo $cat['forumcolwidth'];?>">
                                            <div class="fl_icn_g deanbbs_icon deanactions swing"<?php if(!empty($forum['extra']['iconwidth']) && !empty($forum['icon'])) { ?> style="width: <?php echo $forum['extra']['iconwidth'];?>px;"<?php } ?>>
                                            <?php if($forum['icon']) { ?>
                                                <?php echo $forum['icon'];?>
                                            <?php } else { ?>
                                                <a href="<?php echo $forumurl;?>"<?php if($forum['redirect']) { ?> target="_blank"<?php } ?>><img src="<?php echo IMGDIR;?>/forum<?php if($forum['folder']) { ?>_new<?php } ?>.gif" alt="<?php echo $forum['name'];?>" /></a>
                                            ...
                                            <?php if($forum['todayposts'] && !$forum['redirect']) { ?>
                                                <div class="deantodayposts_bbs" title="今日"> <?php echo $forum['todayposts'];?></div>
                                            <?php } ?>
                                            </div>
                                            <dl<?php if(!empty($forum['extra']['iconwidth']) && !empty($forum['icon'])) { ?> style="margin-left: <?php echo $forum['extra']['iconwidth'];?>px;"<?php } ?>>
                                                <dt>
                ...
                <div id="sd" class="sd">
                    ...
                    <div class="deansideboxs deanactions fadeInUp">
                        ...
                        <div class="deantjdybox">
                        	<div class="deantjdypics">
                            	<!--[diy=deantjdypics]--><div id="deantjdypics" class="area"><div id="frameAPf2Xu" class="frame move-span cl frame-1"><div id="frameAPf2Xu_left" class="column frame-1-c"><div id="frameAPf2Xu_left_temp" class="move-span temp"></div><?php block_display('54');?></div></div></div><!--[/diy]-->
                            	
                            </div>
                        </div>
                        <div class="deantjlists">
                        	<ul>
                            	<!--[diy=deantjlists]--><div id="deantjlists" class="area"><div id="frameoLnVYN" class="frame move-span cl frame-1"><div id="frameoLnVYN_left" class="column frame-1-c"><div id="frameoLnVYN_left_temp" class="move-span temp"></div><?php block_display('55');?></div></div></div><!--[/diy]-->
                    ...
                    <div class="deansideboxs deanactions fadeInUp">
                        ...
                        <div class="deanadsside">
                        	<!--[diy=deanadsside]--><div id="deanadsside" class="area"><div id="frameKuHV6h" class="frame move-span cl frame-1"><div id="frameKuHV6h_left" class="column frame-1-c"><div id="frameKuHV6h_left_temp" class="move-span temp"></div><?php block_display('53');?></div></div></div><!--[/diy]-->
                        </div>
                    </div>
