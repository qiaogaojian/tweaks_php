...
<?php } ?><?php echo adshow("footerbanner/wp a_f/1");?><?php echo adshow("footerbanner/wp a_f/2");?><?php echo adshow("footerbanner/wp a_f/3");?><?php echo adshow("float/a_fl/1");?><?php echo adshow("float/a_fr/2");?><?php echo adshow("couplebanner/a_fl a_cb/1");?><?php echo adshow("couplebanner/a_fr a_cb/2");?><?php echo adshow("cornerbanner/a_cn");?><?php if(!empty($_G['setting']['pluginhooks']['global_footer'])) echo $_G['setting']['pluginhooks']['global_footer'];?>
    ...
    <div class="deanfooter">
    	<div class="deanfttop">
        	<div class="w1180">
            	<div class="deanft_left">
                    ...
                    <div class="deancongz">
                        关注我们 :
                        <a class="weixin" href="javascript:void(0);"><img src="<?php echo $_G['style']['styleimgdir'];?>/footer/weixin.png"><img class="hide" src="<?php echo $_G['style']['styleimgdir'];?>/footer/hide.png"/></a>
                        <a class="weibo" href="#"><img src="<?php echo $_G['style']['styleimgdir'];?>/footer/weibo.png"></a>
                    </div>
                </div>
                <div class="deanft_right">
                	<ul>
                        ...
                        <li>
                        	<h5>快捷导航</h5>
                            <a href="#" target="_blank">优秀作品</a>
                            <a href="#" target="_blank">设计灵感</a>
                            <a href="#" target="_blank">代码下载</a>
        ...
        <div class="deanftbottom">
                <p class="deanpp">
                    <?php if($_G['setting']['site_qq']) { ?><a href="http://wpa.qq.com/msgrd?v=3&amp;uin=<?php echo $_G['setting']['site_qq'];?>&amp;site=qq&amp;menu=yes" target="_blank" title="QQ"><img src="<?php echo IMGDIR;?>/site_qq.jpg" alt="QQ" /></a><span class="pipe">-</span><?php } ?>
                ...
                <p>
                    Powered by <a href="http://www.discuz.net" target="_blank">Discuz!</a> <em><?php echo $_G['setting']['version'];?></em><?php if(!empty($_G['setting']['boardlicensed'])) { ?> <a href="http://license.comsenz.com/?pid=1&amp;host=<?php echo $_SERVER['HTTP_HOST'];?>" target="_blank">Licensed</a><?php } ?>&copy; 2001-2013 <a href="http://www.comsenz.com" target="_blank">Comsenz Inc.</a>&nbsp;&nbsp;<?php if($_G['setting']['icp']) { ?><a href="http://www.miitbeian.gov.cn/" target="_blank"><?php echo $_G['setting']['icp'];?></a><?php } ?>
                </p>
                <div class="deanbutNav">
                  <a title="工商网监" href="#" target="_blank"><img src="<?php echo $_G['style']['styleimgdir'];?>/footer/botpic_r1_c4.png"></a>
                  <a title="安全联盟实名认证" href="#" target="_blank"><img src="<?php echo $_G['style']['styleimgdir'];?>/footer/botpic_r1_c1.jpg"></a>
                  <a href="#" target="_blank">
                  <img src="<?php echo $_G['style']['styleimgdir'];?>/footer/botpic_r1_c5.png" width="100" alt="安全联盟认证"/>
                  </a>
                  <a title="财付通" href="#" target="_blank"><img src="<?php echo $_G['style']['styleimgdir'];?>/footer/botpic_r1_c2.jpg"></a>
                  <a title="支付宝" href="#" target="_blank"><img src="<?php echo $_G['style']['styleimgdir'];?>/footer/botpic_r1_c3.jpg"></a>
                </div>
            </div>
    </div>
