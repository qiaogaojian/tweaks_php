...
0
|| checktplrefresh('./template/dean_code_161226/common/header.htm', './template/default/common/header_common.htm', 1532329866, '2', './data/template/2_2_common_header_portal_index.tpl.php', './template/dean_code_161226', 'common/header_portal_index')
|| checktplrefresh('./template/dean_code_161226/common/header.htm', './template/default/common/header_qmenu.htm', 1532329866, '2', './data/template/2_2_common_header_portal_index.tpl.php', './template/dean_code_161226', 'common/header_portal_index')
|| checktplrefresh('./template/dean_code_161226/common/header.htm', './template/dean_code_161226/common/pubsearchform.htm', 1532329866, '2', './data/template/2_2_common_header_portal_index.tpl.php', './template/dean_code_161226', 'common/header_portal_index')
;?>
...
<?php } ?>                    </div>
                    <div class="deantoptools">
                        ...
                        <div class="deansubnav">
                            <a href="javascript:;" id="qmenu" onMouseOver="delayShow(this, function () {showMenu({'ctrlid':'qmenu','pos':'34!','ctrlclass':'a','duration':2});showForummenu(<?php echo $_G['fid'];?>);})">
                            ...
                            <div class="deandropcon">
                                <div class="deandropcon_download">
                                    <div class="deanappbox">
                                        <img src="<?php echo $_G['style']['styleimgdir'];?>/dl/ewm.png" alt="二维码">
                                        <span>下载手机移动客户端</span>
                                    </div>
