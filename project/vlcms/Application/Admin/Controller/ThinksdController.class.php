 ...
 */
class ThinksdController extends AdminController {
    ...
    public function lists($model = null, $p = 0){
        ...
        if(isset($_REQUEST['AccountID'])){
            $map['AccountID']  =   array('like','%'.$_GET['AccountID'].'%');
            unset($_REQUEST['AccountID']);
        }

         if(isset($_REQUEST['time-start']) && isset($_REQUEST['time-end'])){
            $map["PayTime"] =   array('BETWEEN',array($_REQUEST['time-start'],$_REQUEST['time-end']));
            unset($_REQUEST['time-start']);unset($_REQUEST['time-end']);
        }
         if(isset($_REQUEST['time-starts']) && isset($_REQUEST['time-ends'])){
            $map["createdtime"] =   array('BETWEEN',array($_REQUEST['time-starts'],$_REQUEST['time-ends']));
            unset($_REQUEST['time-starts']);unset($_REQUEST['time-ends']);
        }
           if(isset($_REQUEST['time-startd']) && isset($_REQUEST['time-endd'])){
            $map["createdate"] =   array('BETWEEN',array($_REQUEST['time-startd'],$_REQUEST['time-endd']));
            unset($_REQUEST['time-startd']);unset($_REQUEST['time-endd']);
        }
    ...
    public function edit($model = null, $id = 0,$lists="lists"){
        //获取模型信息
    ...
    public function add($model = null,$lists="lists"){
        //获取模型信息
