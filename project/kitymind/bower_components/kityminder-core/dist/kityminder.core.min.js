    ...
    (b[1] = {
      value: function(a, c, d) {
        ...
        f.register("arc_tp", function(a, b, c, d, f) {
          ...
          if (
            ((p = 0 == a.getIndex() ? 0.4 * p : p),
            (n = e.Vector.fromPoints(l, m)),
            o.push("M", l),
            o.push("A", p, p, 0, 0, 1, m),
            c.setMarker(g),
            g.dot.fill(f),
            c.setPathData(o),
            k && k.getConnection())
            ...
            importJson: function(a) {
              if (a) {
                ...
                return (
                  ...
                  this.setTemplate(a.template || "right"),
        ...
        var e = b.r(17),
          ...
          g = e.createClass("MindEvent", {
            ...
            getPosition: function(a) {
              return this.kityEvent
                ? a && "minder" != a
                  ? this.kityEvent.getPosition.call(this.kityEvent, a)
                  : this.kityEvent.getPosition(this.minder.getRenderContainer())
                : void 0;
            },
          ...
          h = e.createClass("Minder", {
            constructor: function(a) {
              ...
              for (var b, c = g.slice(); c.length; )
                (b = c.shift()),
                  "function" == typeof b && b.call(this, this._options);
        ...
        function f(a, b) {
          ...
          if ("root" == f) {
            ...
            for (var i, j; (i = c.shift()); )
              "children" != i &&
                ("undefined" != typeof j && (d = d.getChild(j)), (j = +i));
            (b.index = j), (b.node = d);
          }
          ...
          switch (k) {
            ...
            case "data.remove":
              var l,
                m = b.node.data;
              for (c = b.dataPath.slice(); m && c.length > 1; )
                (l = c.shift()),
                  l in m ? (m = m[l]) : "remove" != b.op && (m = m[l] = {});
              m && ((l = c.shift()), (m[l] = b.value)),
                "expandState" == l ? d.renderTree() : d.render(),
                a.layout();
          }
          ...
          f.extendClass(h, {
            render: function() {
              return this.attached
                ? (this.getMinder().renderNode(this), this)
                : void 0;
            },
            renderTree: function() {
              if (this.attached) {
              ...
              this.on("keydown", function(c) {
                for (var d in a)
                  if (a[b](d) && c.isShortcutKey(d)) {
                    ...
                    if (
                      e.__statusCondition &&
                      e.__statusCondition != this.getStatus()
                    )
                      return;
                    e(), c.preventDefault();
                  }
      ...
      value: function(a, c, d) {
        ...
        (c.register = e),
          ...
          f.extendClass(h, {
            ...
            getTheme: function(a) {
              return this._theme || this.getOption("defaultTheme") || "snow";
            },
          ...
          j.register("Theme", {
            defaultOptions: { defaultTheme: "snow" },
            commands: {
                ...
                bold: e.createClass("boldCommand", {
                  ...
                  queryState: function() {
                    ...
                    return 0 === a.length
                      ? -1
                      : (a.forEach(function(a) {
                          return a && a.getData("font-weight")
                            ? ((c = 1), !1)
                            : void 0;
                        }),
                        c);
          ...
          l = e.createClass("TreeDragger", {
            ...
            dragMove: function(a) {
              ...
              if (this._startPosition) {
                ...
                for (var f = 0; f < this._dragSources.length; f++)
                  this._dragSources[f].setLayoutOffset(
                    this._dragSources[f].getLayoutOffset().offset(c)
                  ),
                    d.applyLayoutResult(this._dragSources[f]);
                this._dropTest()
    ...
    (b[46] = {
      value: function(a, c, d) {
        ...
        j.register("Expand", function() {
          ...
          return {
            commands: { expand: j, expandtolevel: l, collapse: m },
            events: {
          ...
          renderers: {
            right: e.createClass("hyperlinkrender", {
              ...
              update: function(a, b, c) {
                ...
                return (
                  a.setTranslate(c.right + g + 2, -5),
                  new e.Box({ x: c.right + g, y: -11, width: 24, height: 22 })
                );
              }
            })
          }
            ...
            d = e.createClass("NoteIconRenderer", {
              ...
              update: function(a, b, c) {
                ...
                return (
                  ...
                  a.setTranslate(d, f),
                  new e.Box(d, Math.round(f - a.height / 2), a.width, a.height)
                );
              }
            });
          ...
          i = e.createClass("OutlineRenderer", {
            ...
            update: function(a, b, c) {
              ...
              if (d && "circle" == d) {
                var l = Math.pow,
                  m = Math.round;
                (k = m(Math.sqrt(l(j.width, 2) + l(j.height, 2)) / 2)),
                  (j.x = c.cx - k),
                  (j.y = c.cy - k),
                  (j.width = 2 * k),
                  (j.height = 2 * k);
                ...
                a
                  ...
                  .fill(
                    b.getData("background") ||
                      b.getStyle(n + "background") ||
                      b.getStyle("background")
                  )
                  .stroke(
                    b.getStyle(n + "stroke" || b.getStyle("stroke")),
                    b.getStyle(n + "stroke-width")
                  ),
                new e.Box(j)
              );
            }
        ...
        h.register("PriorityModule", function() {
          var a = [
            ...
            h = e.createClass("PriorityIcon", {
              ...
              create: function() {
                var a, d, f, g;
                (a = new e.Path().setPathData(c).fill("white")),
                  (d = new e.Path().setPathData(b).setTranslate(0.5, 0.5)),
                  (f = new e.Path()
                    .setPathData(c)
                    .setOpacity(0.8)
        ...
        h.register("Resource", function() {
          var a = (function() {
              ...
              return (
                ...
                (j = function(a) {
                  return (
                    0 > a && (a += k), ("00000000" + a.toString(16)).slice(-8)
                  );
                }),
                (f = [
                ...
                function(f, g) {
                  ...
                  var k, l, m, n, o, p, q, r;
                  for (l = a.slice(0), k = e.slice(0, 8), c = 0; 4 > c; c += 1)
                    k[c] ^= g[c];
                  if (
                    ((m = 16 * f.length),
                  ...
                  for (
                    ...
                    for (
                      ...
                      for (r = 0; 8 > r; r += 1)
                        4 > r ? b(r, r, r, r, r) : b(r, r, r + 1, r + 2, r + 3);
                    for (r = 0; 8 > r; r += 1)
                      l[r] ^= g[r % 4] ^ h[r] ^ h[r + 8];
                  }
                  return l.map(j).join("");
            ...
            c = (function() {
              ...
              return {
                selectStart: function(a) {
                  return a.originEvent.button || a.originEvent.altKey
                    ? void 0
                    : c
                      ? this.selectEnd()
                ...
                selectMove: function(h) {
                  if ("textedit" != a.getStatus() && c) {
                    ...
                    (k.left = Math.round(k.left)),
                      ...
                      (k.right = Math.round(k.right)),
                      (k.bottom = Math.round(k.bottom)),
                      d.getDrawer().pipe(function() {
                        this.clear(),
                          this.moveTo(k.left, k.top),
                          this.lineTo(k.right, k.top),
                          this.lineTo(k.right, k.bottom),
                          this.lineTo(k.left, k.bottom),
                          this.close();
                      }),
                      a.getRoot().traverse(function(a) {
          ...
          l = e.createClass("TextRenderer", {
            ...
            update: function(a, b) {
              ...
              var q,
                ...
                u = g.length,
                v = a.getItems().length;
              if (v > u) for (q = u, r; (r = a.getItem(q)); ) a.removeItem(q);
              else if (u > v)
                for (var w = u - v; w--; )
            ...
            _bind: function() {
              function a(a) {
                if (d) {
                  ...
                  e.setStyle(
                    "cursor",
                    "hand" == b._minder.getStatus() ? "-webkit-grab" : "default"
                  ),
              ...
              this._minder
                .on(
                  ...
                  function(a) {
                    2 == a.originEvent.button && a.originEvent.preventDefault(),
                  ...
                  e.Browser.mac || (b = -b),
                    Math.abs(b) > 100 &&
                      ...
                      (this._wheelZoomTimeout = setTimeout(function() {
                        c.getPaper()._zoom || 1;
                        0 > b
                          ? c.execCommand("zoom-in")
                          : b > 0 && c.execCommand("zoom-out");
                      }, 100)),
                      a.originEvent.preventDefault());
                }
              }
      ...
      value: function(a, c, d) {
        ...
        function f(a) {
          var b,
            ...
            l = j.width + 1,
            m = j.height + 1;
          (b = h.shapeNode.getAttribute("transform")),
            h.shapeNode.setAttribute("transform", "translate(0.5, 0.5)"),
            i.translate(-j.x, -j.y),
            (c = h.container.innerHTML),
            i.translate(j.x, j.y),
            h.shapeNode.setAttribute("transform", b),
            (d = document.createElement("div")),
            (d.innerHTML = c),
            (e = d.querySelector("svg")),
            e.setAttribute("width", j.width + 1),
            e.setAttribute("height", j.height + 1),
            e.setAttribute(
              "style",
            ...
            (c = c.replace(/&nbsp;/g, "&#xa0;")),
            (f = new Blob([c], { type: "image/svg+xml" })),
        ...
        function g(a, b) {
          function c(a, b) {
            a.save(),
              (a.fillStyle = b),
              a.fillRect(0, 0, m.width, m.height),
              a.restore();
          }
              ...
              .then(
                function(a) {
                  for (var b = 0; b < a.length; b++)
                    d(n, a[b].element, a[b].x, a[b].y, a[b].width, a[b].height);
                  return (
                    k.revokeObjectURL(u), document.body.appendChild(m), g(m)
                  );
                },
                function(a) {
                  return (
        ...
        function e(a, b, c) {
          ...
          function f(a, b, c) {
            if (a && "defs" !== a.tagName) {
              ...
              if (a.children)
                for (var k = 0, l = a.children.length; l > k; k++)
                  f(a.children[k], b, c);
            }
          }
